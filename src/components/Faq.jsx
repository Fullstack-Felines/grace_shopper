    ...
    <div class="wrapper border-b-2 mt-9 bg-tan overflow-hidden mx-auto max-w-md rounded shadow-lg">
      ...
      <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
        <div class="w-full lg:w-1/2 px-4 py-2">
          <details class="mb-4">
            <summary class="font-semibold bg-red rounded-md py-2 px-4">
          ...
          <details class="mb-4">
            ...
            <span>
              ...
              shelter in the first place. An important part of the process is to
              match the lifestyle and needs of the adopter with the individual
              dog or cat. If the screening process occasionally seems overly
              strict, try to remember that the shelter’s first priority is to
              protect the animal’s best interests.
            </span>
          </details>
          <details class="mb-4">
            <summary class="font-semibold bg-red rounded-md py-2 px-4">
          ...
          <details class="mb-4">
            ...
            <span>
              ...
              ones! We are very experienced with pet transitions and welcome the
