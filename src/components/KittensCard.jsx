  ...
  return (
    <div class="rounded-lg shadow-lg overflow-none h-full bg-cardpaper">
      ...
      <div class="py-4 px-2 bg-cardpaper rounded-lg ">
        ...
        <p class="text-xl text-black flex justify-center m-2">{kitten.breed}</p>
        {kitten.available ? (
        ...
        {user.is_admin ? (
          isEditing ? (
            <div class="flex justify-center mt-4 bg-cardpaper opacity-90 w-ful hover:opacity-100  py-1 rounded object-bottom">
              <form
                onSubmit={async (e) => {
                  e.preventDefault();
              ...
              >
                ...
                <button
                  type="Submit"
                  class="mb-1.5 block w-full text-center text-white bg-coral opacity-80 hover:opacity-100 px-2 py-1.5 rounded-md"
                >
                  Update kitten!
                </button>
              </form>
