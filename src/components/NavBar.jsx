...
export default function NavBar() {
  ...
  return (
    <div class="bg-pink px-2 sm:px-4 py-2.5 rounded min-h-80">
      <nav class="flex justify-evenly flex-col sm:flex-row sm:justify-center items-center mx-auto">
        <Link to="/" class="flex ">
          <img
            src="https://res.cloudinary.com/dkmoq49jf/image/upload/v1661282043/Fullstack_Felines_1_o93p2j.png"
            class="object-contain h-25 sm:h-14 transition duration-300 hover:scale-125 sm:flex-1 sm:flex-row sm:ml-5 sm:justify-start"
          />
        </Link>
        {/* <div class="flex text-center sm:justify-center  sm:flex-row sm:w-1/3"> */}
        <Link
          to="/"
          class="text-coral  text-xl font-bold transform  hover:text-white transition duration-300 hover:scale-125 mx-2 flex flex-row"
        >
          Home
        </Link>
        <Link
