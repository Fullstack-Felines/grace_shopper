...
export default function NavBar() {
  ...
  return (
    <div class="bg-pink px-2 sm:px-4 py-2.5 rounded min-h-80">
      <nav class="flex justify-evenly flex-col sm:flex-row sm:justify-evenly items-center mx-auto">
        <Link to="/" class="flex ">
          <img
            src="https://res.cloudinary.com/dkmoq49jf/image/upload/v1661282043/Fullstack_Felines_1_o93p2j.png"
            class="object-contain h-25 sm:h-14 xl:h-20 transition duration-300 hover:scale-125 sm:flex-1 sm:flex-row sm:ml-5 sm:justify-start m-2"
          />
        </Link>
